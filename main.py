...
def main(sentence): 
  ...
  files = glob.glob('/home/vish/output/html/audio/*')
  files.extend(glob.glob('/home/vish/output/html/videos/*'))
  ...
  for i,word in enumerate(sentence.split()):
     ...
     tts.save(f'/home/vish/output/html/audio/{i}.wav')
     #tts.save(f'audio/{i}.wav')
     audio = AudioSegment.from_file(f'/home/vish/output/html/audio/{i}.wav') #audio/{i}.wav')
     words[i]['length'] = audio.duration_seconds/len(words[i]['word'])


     args = argparse.Namespace(audio=f'/home/vish/output/html/audio/{i}.wav', box=[-1, -1, -1, -1], \
     ...
     inference.main(args)
     with open('/home/vish/output/html/output.html', 'w+') as f:
         f.write(str(words))
